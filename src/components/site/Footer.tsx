    ...
    <footer className="border-t border-border px-6 pt-20 pb-10 bg-card/30">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-16">
        <div className="md:col-span-1">
          <img
            src={logoAsset.url}
            alt="Hanuman Digitals"
            className="h-14 w-auto object-contain mb-6 select-none"
            style={{ mixBlendMode: "screen" }}
            draggable={false}
          />
          <p className="text-sm text-muted-foreground leading-relaxed">
            Frames That Speak — capturing timeless memories across India & the USA for nearly five decades.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li>Hyderabad · Adilabad · Nirmal</li>
            <li>Nizamabad · Princeton, TX (USA)</li>
